...
export function renderProductsPage(root){
     ...
     <div style="border:1px solid #ddd; padding: 12px; border-radius: 10px;margin-bottom: 14px;">
        ...
        <div style="display: grid; grid-template-columns:1fr 1fr; gap: 10px;">
            <div>
                ...
                <input id="pName" type="text" placeholder="Ej: Paquete1" style="width: 100%;padding: 8px;">
            </div>    
            <div>
                <label for="">Categoria</label>
                <input id="pCategory" type="text" placeholder="Ej: Matrimonios" style="width: 100%;padding: 8px;">
            </div>    
            <div>
    ...
    function validateInputs() {
        ...
        if(Number.isNaN(vendidos) || vendidos <0) return {ok: false, message: "Contratos inválido"}
